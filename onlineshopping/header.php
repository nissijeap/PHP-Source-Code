...
<html lang="en">
	...
	<body>
					...
					<div class="row">
						...
						<div class="col-md-3">
							<div class="header-logo">
								<a href="#" class="logo">
								<img src="img/header.png" style="width: 170px; height: 60px">
							...
							<div class="header-search">
								<form>
									<select class="input-select">
										<option value="0">All Categories</option> <!--medicine categories-->
										<option value="1">Men</option>
										<option value="1">Women </option>
									</select>
									<input class="input" id="search" type="text" placeholder="Search medicine here">
		...
		<nav id='navigation'>
			<!-- container -->
            <div class="container" id="get_category_home"> <!--here and navigation-->
