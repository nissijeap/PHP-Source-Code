								...
								<a href='product.php?p=$pro_id'><div class='product'>
									...
									<div class='product-body'>
										...
										<div class='product-btns'>
											<button class='compare-price'><i class='fa fa-exchange'></i><span class='tooltipp'>Compare Price</span></button>
										</div>
									</div>
									<div class='add-to-cart'>
										<button pid='$pro_id' id='product' class='add-to-cart-btn block2-btn-towishlist' href='#'><i class='fa fa-map-marker'></i>Find Pharmacy</button>
									</div>
								</div>
							</div>
