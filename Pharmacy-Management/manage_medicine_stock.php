    ...
    <div class="container-fluid">
      <div class="container">
        ...
        <?php
          ...
          createHeader('shopping-bag', 'Manage Medicines Inventory', 'Manage Existing Medicine Stock');
        ?>
        <!-- header section end -->
        ...
        <div class="row">
          ...
          <div class="col-md-12 form-group form-inline">
            ...
            &emsp;<input type="text" class="form-control" id="by_suppliers_name" placeholder="By Pharmacy Name" onkeyup="searchMedicineStock(this.value, 'SUPPLIER_NAME');">
