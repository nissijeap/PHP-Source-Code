            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li> <a href="categories.php" aria-expanded="false"><i class="fa fa-list-ul"></i><span class="hide-menu">Classification</span></a>
                        </li> 

                        <!--<li> <a href="medicine.php" aria-expanded="false"><i class="fa fa-heartbeat"></i><span class="hide-menu">Medicine</span></a>
                        </li> -->


                  <?php if(isset($_SESSION['userId'])) { ?>
                        <li> <a class="has-arrow" href="#" aria-expanded="false"><i class="fa fa-heartbeat"></i><span class="hide-menu">Medicine</span></a>
                            <ul aria-expanded="false" class="collapse">
                           
                                <li><a href="add-medicine.php">Add Medicine</a></li>

                                <li><a href="medicine.php">Stored Medicines</a></li>
                            </ul>
                        </li>
                    <?php }?>

                    <?php if(isset($_SESSION['userId'])) { ?>
                        <li> <a class="has-arrow" href="#" aria-expanded="false"><i class="fa fa-medkit"></i><span class="hide-menu">Inventory</span></a>
                            <ul aria-expanded="false" class="collapse">
                           
                                <li><a href="add-product.php">Add Stock</a></li>

                                <li><a href="product.php">Manage Stock</a></li>
