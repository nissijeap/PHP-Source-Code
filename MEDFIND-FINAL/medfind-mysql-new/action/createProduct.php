...
if($_POST) {	
  ...
  if($med_quan == 0){
	...
	$med_stat = "Available";
				...
				$sql = "INSERT INTO med_pharm (med_name, med_quan, med_price, med_stat, med_added, med_exp, pharmacy, images) 
				VALUES ('$med_name', '$med_quan', '$med_price', '$med_stat', '$med_added', '$med_exp', '$pharm', '$filename')";
