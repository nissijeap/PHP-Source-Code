						...
						<div class="row">
							<div class="products-tabs">
								...
								<div id="tab1" class="tab-pane active">
                                    ...
                                    $sql = "SELECT med_pharm.med_pharm_id, medicine.med_name, med_pharm.med_price, packaging.pack_name, med_pharm.med_quan, med_pharm.images, pharmacy_details.direction 
									  from med_pharm
									  inner join medicine
