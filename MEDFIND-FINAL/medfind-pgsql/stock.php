...
$date=date('Y-m-d');
$sql = ("SELECT * from get_stock($pharm)");
       ...
       <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-primary">Stockout Medicines</h3> </div>
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                        <li class="breadcrumb-item active">Stockout Medicines</li>
                    </ol>
                </div>
            </div>
                 ...
                 <div class="card">
                            ...
                            <h3 class="text-primary">List of Stockout Medicines</h3>
