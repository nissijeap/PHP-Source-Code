                            ...
                            <table id="table2" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr style="color:black">
                                        ...
                                        <td style="color:black"><?php echo $row['clsn_name'] ?></td>
                                        <td>
                                            <a href="editcategory.php?id=<?php echo $row['clsn_id']?>"><button type="button" class="btn btn-xs btn-primary" ><i class="fa fa-pencil"></i></button></a>
                                            <a href="action/removeCategories.php?id=<?php echo $row['clsn_id']?>" ><button type="button" class="btn btn-xs btn-danger" onclick="return confirm('Are you sure to delete this record?')"><i class="fa fa-trash"></i></button></a>
                                        </td>
                                    </tr>
                                    <?php    } ?>
                                </tbody>
