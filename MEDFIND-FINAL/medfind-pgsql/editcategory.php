...
$sql="SELECT * from edit_class('".$_GET['id']."')";
                                    ...
                                    <form class="form-horizontal" method="POST"  id="submitBrandForm" action="action/editCategories.php?id=<?php echo $_GET['id'];?>"enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-9">
                                                  <input type="text"  class="form-control"id="class_name" placeholder="Medicine Type" name="class_name"  value="<?php echo $row['clsn_name']?>"required="" pattern="^[a-zA-z]+$"/>
                                                </div>
                                            </div>
                                        </div>
