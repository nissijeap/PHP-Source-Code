...
$sql = ("SELECT * from get_medpharm($pharm)");
                        ...
                        <table id="table2" class="table table-bordered table-striped">
                            ...
                            <tbody>
                                ...
                                <tr style="color:black">
                                    ...
                                    <td><img src="./image/<?php echo $row['mdcn_images']; ?>" style="width: 50px; height: 50px; object-fit:cover;"></td>
                                    <td style="color:black"><?php echo $row['mdcn_name'] ?></td>
                                    <td style="width:500px">
                                        <form method="POST" action="action/adjust_quan.php?id=<?php echo $row['mdcn_id']?>">
                                        ...
                                        <input type="number" min="0" name="cur_quan" style="width: 100%" value="<?php echo $row['mdcn_quan'] ?>"> 
                                    ...
                                    <td style="color:black"><?php echo $row['mdcn_price'] ?></td>
                                    ...
                                    <td style="color:black"><?php echo $row['mdcn_added'] ?></td>
                                    <td style="color:black"><?php echo $row['mdcn_exp'] ?></td> 
                                    <td>
                                        <a href="editmed.php?id=<?php echo $row['mdcn_id']?>"><button type="button" class="btn btn-xs btn-primary" ><i class="fa fa-pencil"></i></button></a>
                                        <a href="action/removeProduct.php?id=<?php echo $row['mdcn_id']?>" ><button type="button" class="btn btn-xs btn-danger" onclick="return confirm('Are you sure to delete this record?')"><i class="fa fa-trash"></i></button></a>
                                    </td>
                                </tr>
                                <?php }?>
                            </tbody>
