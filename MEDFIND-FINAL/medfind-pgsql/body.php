						...
						<div class="row">
							<div class="products-tabs">
								...
								<div id="tab1" class="tab-pane active">
                                    ...
                                    $sql = "SELECT * from index_view(1)";
									$run_query = pg_query($dbconn, $sql);
									while($row = pg_fetch_array($run_query)){
										$med_id = $row['iv_id'];
										$med_name = $row['iv_name'];
			                            $med_price = $row['iv_price'];
			                            $pack_name = $row['iv_pack'];
			                            $med_quan = $row['iv_quan'];
										$image = $row['iv_images'];
	                                    $direction = $row['iv_direction'];
