...
<?php } else { ?>
            ...
            <img src="./image/<?php echo $row['dtls_cover']; ?>" style="width: 100%; height: 100%; object-fit:cover;">
    ...
    <div class="container container-table">
                            <a href="editprofile.php?id=<?php echo $row['dtls_id']?>"><button type="button" class="btn btn-xs btn-primary" ><i class="fa fa-pencil"> Edit Profile</i></button></a>
