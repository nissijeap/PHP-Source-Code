  ...
  <div class="leftpanel">
    ...
    <div class="leftpanelinner">
      ...
      <ul class="nav nav-pills nav-stacked nav-bracket">
        ...
        <li><a href="customerview.php"><i class="fa fa-user"></i><span>View Customers</span></a></li>
        
            <li><a href="staffview.php"><i class="fa fa-users"></i>View Staff & Designations</a></li>
