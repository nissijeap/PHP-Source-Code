...
$usid = $usid->fetch(PDO::FETCH_ASSOC);
 ...
 ?>
    ...
    <div class="pageheader">
      <h2><i class="fa fa-cog"></i> Shop Profile </h2>
    </div>
...
$res = $pdo->exec("UPDATE general_setting SET sitename='".$sitename."', address='".$address."', mobile='".$mobile."', email='".$email."', currency='".$currency."' WHERE id='1'");
if($res){
...
$data = $pdo->query("SELECT sitename, address, mobile, email, currency FROM general_setting WHERE id='1'");
...
?>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-6"><input name="address" value="<?php echo $data['address']; ?>" class="form-control" type="text"></div>
            </div>
...
<br/>
       ...
       Current Image : <br/><img src="img/logo.png" width="auto" height="200px" alt="IMG">
