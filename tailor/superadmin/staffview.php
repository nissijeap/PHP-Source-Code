 ...
 ?>
    ...
    <link href="../bower_components/datatables-responsive/css/dataTables.responsive.css" rel="stylesheet">
        ...
        <div id="page-wrapper">
            ...
            <h2><i class="fa fa-users"></i> All Staff and Designations</h2>
          </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
            <br></br>
                       ...
                       <br></br>
                       <a href='staffadd.php?id=$data[id]' class='btn btn-success btn-xs' style="font-size: 20px; padding: 10px; margin-left: 1100px">Add Staff</a>
...
$ddaa = $pdo->query("SELECT id, stafftype, address, fullname, phonenumber, staff_username, staff_password FROM staff ORDER BY id");
