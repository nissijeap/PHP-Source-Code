...
$res2 = $pdo->exec("UPDATE `orders` SET paid = paid + '$amount' WHERE `id` = '$order'");
$res3 = $pdo->exec("UPDATE `orders` SET balance = amount - paid WHERE `id` = '$order'");
			...
			<form action="" method="post">
                ...
                <div class="form-group">
					...
					<label>Amount</label><br/>
                 	<?php echo($currency);?> <input id="amount" type="number" value="<?php echo $orderr; ?>" min="0" name="amount" style="width:200px; height: 40px;" /><br/><br/>
				</div>
				<div class="form-group">
