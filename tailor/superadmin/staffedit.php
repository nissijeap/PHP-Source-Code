...
$res = $pdo->exec("UPDATE `staff` SET `stafftype`='".$stafftype."',`address`='".$address."',`fullname`='".$fullname."',`phonenumber`='".$phonenumber."', staff_username='".$staff_username."', staff_password='".$staff_password."' WHERE id='".$eid."'");
...
<?php
$oldd = $pdo->query("SELECT stafftype, address, fullname, phonenumber, staff_username, staff_password FROM staff WHERE id='".$eid."'");
...
?>
				...
				<div class="form-group">
					...
					<label>Username</label><br/>
                 	<input type="text" name="staff_username" style="width:200px; height: 40px;" value="<?php echo($old['staff_username']) ?>" /><br/><br/>
				</div>

				<div class="form-group">
					
					<label>Password</label><br/>
                 	<input type="text" name="staff_password" style="width:200px; height: 40px;" value="<?php echo($old['staff_password']) ?>" /><br/><br/>
				</div>
