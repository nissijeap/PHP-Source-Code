 ...
 ?>
    ...
    <link href="../bower_components/datatables-responsive/css/dataTables.responsive.css" rel="stylesheet">
        ...
        <div id="page-wrapper">
            ...
            <h2><i class="fa fa-money"></i> All Incomes</h2>
          </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
			...
			<br></br>
                       ...
                       <br></br>
                       <a href='incadd.php?id=$data[id]' class='btn btn-success btn-xs' style="font-size: 20px; padding: 10px; margin-left: 1050px">Add Income</a>
