  ...
  <div class="leftpanel">
    ...
    <div class="leftpanelinner">
      ...
      <ul class="nav nav-pills nav-stacked nav-bracket">
        ...
        <li class="nav-parent"><a href="#"><i class="fa fa-users"></i> <span>Staff Management</span></a>
          <ul class="children">

          <!--<li><a href="staffcatadd.php"><i class="fa fa-caret-right"></i>Add Designation</a></li>-->
          <li><a href="staffcatview.php"><i class="fa fa-caret-right"></i>Designations</a></li>
          <li><a href="staffview.php"><i class="fa fa-caret-right"></i>Staff & Designations</a></li>
        ...
        <li><a href="setgeneral.php"><i class="fa fa-cog"></i><span>Shop Profile</span></a></li>
