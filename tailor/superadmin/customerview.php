    ...
    <link href="../bower_components/datatables-responsive/css/dataTables.responsive.css" rel="stylesheet">
        ...
        <div id="page-wrapper">
			...
			<div class="contentpanel">
                     ...
                     <br></br>
                       <a href='customeradd.php?id=$data[id]' class='btn btn-success btn-xs' style="font-size: 20px; padding: 10px; margin-left: 1000px">Add Customer</a>
...
$ddaa = $pdo->query("SELECT id, address, fullname, phonenumber, sex FROM customer ORDER BY id");
    while ($data = $ddaa->fetch(PDO::FETCH_ASSOC))
    {
		...
		$measure = '<a href="addmeasurement.php?id='.$data['id'].'" class="btn btn-info btn-xs">Add Measurement</a>';
		}
		else{
		$measure = '<a href="editmeasurement.php?id='.$data['id'].'" class="btn btn-info btn-xs">Edit Measurement</a>';
		}
...
$measure
<a href='viewmeasurement.php?id=$data[id]' class='btn btn-warning btn-xs'>View Measurement</a>
<a href='customeredit.php?id=$data[id]' class='btn btn-info btn-xs'>Update</a>
