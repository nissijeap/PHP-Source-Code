...
$res = $pdo->exec("INSERT INTO staff SET stafftype='".$stafftype."', fullname='".$fullname."', address='".$address."', phonenumber='".$phonenumber."', staff_username='".$staff_username."', staff_password='".$staff_password."'");
if($res){
...
?>
                ...
                <div class="form-group">
					...
					<label>Username</label><br/>
                 	<input type="text" name="staff_username" style="width:200px; height: 40px;" /><br/><br/>
				</div>
                
                <div class="form-group">
					
					<label>Password</label><br/>
                 	<input type="text" name="staff_password" style="width:200px; height: 40px;" /><br/><br/>
				</div>
