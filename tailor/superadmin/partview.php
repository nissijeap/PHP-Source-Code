 ...
 ?>
    ...
    <link href="../bower_components/datatables-responsive/css/dataTables.responsive.css" rel="stylesheet">
        ...
        <div id="page-wrapper">
            ...
            <h2><i class="fa fa-child"></i> All Measurement Parts</h2>
          </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
			...
			<br></br>
                       ...
                       <br></br>
    <a href='partadd.php?id=$data[id]' class='btn btn-success btn-xs' style="font-size: 20px; padding: 10px; margin-left: 1100px">Add Part</a>
...
$rname =	$rname->fetch(PDO::FETCH_ASSOC);	
 echo "                                 <tr>
                                            <td>$data[id]</td>
                                            <td>".(isset($rname['title']) ? $rname['title'] : "N/A")."</td>
											<td>$data[title]</td>
