...
$res = $pdo->exec("INSERT INTO `orders`(`tracking_number`, `customer`, `description`, `amount`, `paid`, `received_by`, `date_received`, `completed`, `date_collected`) VALUES ('$trackingnum','$customer','$desc','$amount','$paid','$received_by','$date_received','$completed','$date_collected')");
...
?>
				...
				<div class="form-group">
					...
					<label>Tracking Number</label><br/>
                 	<input type="text" name="tracking_number" style="width:200px; height: 40px;" /><br/><br/>
				</div>
